    ...
    public class Quests : ModPlayer, ILocalizedModType
    {
        ...
        public void BeggarQuests()
        {
            ...
            if (FoodQuest == 20)
            {
                ...
                for (int num66 = 0; num66 < 58; num66++)
                {
                    if (Player.inventory[num66].buffType == 26 || Player.inventory[num66].buffType == 206 || Player.inventory[num66].buffType == 207)
                    {
                        Player.inventory[num66].stack--;
                        FoodQuest = 90;                     
                            ...
                            case 15:
                                {
                                    foreach (var quests in activeQuests)
                                    {
                                        ...
                                        string Stage = quests.DisplayStage;
                            ...
                            case 16:
                                {
                                    foreach (var quests in activeQuests)
                                    {
                                        ...
                                        sb.Draw(completedtex, new Vector2(bookcoord.X + 520 + curfont.MeasureString(Name).X * 0.9f, bookcoord.Y + 87), Color.White);
                                        Utils.DrawBorderStringFourWay(sb, curfont, Name, bookcoord.X + 516, bookcoord.Y + 90, Color.White, Color.Black, Vector2.Zero, 0.9f);
                                        sb.Draw(activetex, new Vector2(bookcoord.X + 520 + curfont.MeasureString(Stage).X * 0.9f, bookcoord.Y + 107), Color.White);
