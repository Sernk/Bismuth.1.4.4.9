    ...
    public class SwampHound : ModNPC {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
            if (NPC.spriteDirection < 0) {
                spriteBatch.Draw(ModContent.Request<Texture2D>("Bismuth/Glow/SwampHound_Glow").Value, NPC.Center - Main.screenPosition + new Vector2(-10, 8), new Rectangle?(NPC.frame), Color.White * 0.8f, NPC.rotation, new Vector2(25f, 32f), 1f, SpriteEffects.None, 0.0f);
            }
            else {
                spriteBatch.Draw(ModContent.Request<Texture2D>("Bismuth/Glow/SwampHound_Glow").Value, NPC.Center - Main.screenPosition + new Vector2(-8, 8), new Rectangle?(NPC.frame), Color.White * 0.8f, NPC.rotation, new Vector2(25f, 32f), 1f, SpriteEffects.FlipHorizontally, 0.0f);
            }
        }
