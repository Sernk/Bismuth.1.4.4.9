    ...
    public class Alchemist : ModNPC {
        ...
        public override void SetChatButtons(ref string button, ref string button2) {
            ...
            if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest != 200) {
                if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 30) { button = AlchemistButton_9; }
                else { button = Lang.inter[28].Value; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 0 && Main.LocalPlayer.GetModPlayer<Quests>().EquipmentQuest == 100 && BismuthWorld.downedSkeletron) { button2 = AlchemistButton_1; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 5) { button2 = AlchemistButton_2; }
                    ...
                    for (int num66 = 0; num66 < 58; num66++) {
                        if (Main.LocalPlayer.inventory[num66].type == ModContent.ItemType<SunrisePicture>() && Main.LocalPlayer.inventory[num66].stack > 0) {
                            ...
                            if (Main.netMode == NetmodeID.MultiplayerClient) {
                                ModPacket alchemistTempStartIndex = Mod.GetPacket();
                                alchemistTempStartIndex.Write((byte)1);
                                alchemistTempStartIndex.Write(true);
                                alchemistTempStartIndex.Send();
                            }
                            else { TempNPCs.AlchemistTempStart = true; }
                        }
                    }
                    if (!temp && Main.npcChatText != Alchemist_4) { button2 = AlchemistButton_4; }
                }
                if (TempNPCs.AlchemistTemp && Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 0) { button2 = AlchemistButton_5; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 5) { button2 = AlchemistButton_6; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 20) {
                    ...
                    if (!temp && Main.npcChatText != Alchemist_9) { button2 = AlchemistButton_8; }
                }
                ...
                if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 40) {
                    ...
                    if (!temp && Main.npcChatText != Alchemist_12 && Main.npcChatText != Alchemist_14) { button2 = AlchemistButton_12; }
                }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 0) { button2 = AlchemistButton_13; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 5) { AlchemistButton_14 = this.GetLocalization("Chat.AlchemistButton_14").Value; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 5) { button2 = AlchemistButton_14; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 20) {
                    for (int num66 = 0; num66 < 58; num66++) {
                        if (Main.LocalPlayer.inventory[num66].type == ModContent.ItemType<TabulaSmaragdina>() && Main.LocalPlayer.inventory[num66].stack > 0) { button2 = AlchemistButton_15; }
                    }
                }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 30 && Main.npcChatText != Alchemist_20) { button2 = AlchemistButton_16; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneCharging == 0 && Main.npcChatText != Alchemist_23) { button2 = AlchemistButton_17; }
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneCharging == 10) { button2 = AlchemistButton_18; }
                if (TempNPCs.AlchemistPreSkeletonNewQuest) {
                    Player player = Main.LocalPlayer;
                    IQuest quest = QuestRegistry.GetAvailableQuests(player, BaseQuest.Alchemist).FirstOrDefault();
                    if (TempNPCs.AlchemistPreSkeletonNewQuest && quest != null) { button2 = quest.GetButtonText(player); }
                }
        ...
        public override void AddShops() {
            Condition KilledEoC = Condition.DownedEyeOfCthulhu;
            Condition PhilosopherStoneQuest = new(string.Format(LocUtil.Loc("Condition.CompleteAlchemistQuests"), LocUtil.Loc("QuestsSystem.Quests.Quests.Quest11Name")), () => Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 100);
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shopName) {
            ...
            if (firstButton) {
                ...
                if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 100) { quests.PholosopherStoneCharging(); }
                if (TempNPCs.AlchemistPreSkeletonNewQuest == false) { quests.AlchemistQuests(); }
            }
        }
        public override string GetChat() {
            ...
            var quest = QuestRegistry.GetAvailableQuests(player, BaseQuest.Alchemist).FirstOrDefault();
            if (quest != null) {
                if (TempNPCs.AlchemistPreSkeletonNewQuest) { return quest.GetChat(NPC, player); }
                else if (TempNPCs.AlchemistNewQuest) { return quest.GetChat(NPC, player); }
            }
            if (Main.LocalPlayer.GetModPlayer<Quests>().EquipmentQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 0 && BismuthWorld.downedSkeletron) { return Alchemist_1; }
            else if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest == 20) { return Alchemist_3; }
            else if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 20) { return Alchemist_8; }
            else if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 40) { return Alchemist_13; }
            else if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest == 100 && Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest == 0) { return Alchemist_16; }
            else {
                if (NPC.FindFirstNPC(NPCID.WitchDoctor) >= 0 && WorldGen.genRand.Next(0, 4) == 0) { return string.Format(this.GetLocalization("Chat.AlchemistNQ_2").Value, Main.npc[NPC.FindFirstNPC(NPCID.WitchDoctor)].GivenName); }
        ...
        public override void AI() {
            ...
            if (Main.LocalPlayer.talkNPC != -1) {
                ...
                if (Main.npc[Main.LocalPlayer.talkNPC].type != NPC.type) {
                    if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest < 10) { Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest = 0; }
                    if (Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest < 10) { Main.LocalPlayer.GetModPlayer<Quests>().PotionQuest = 0; }
                    if (Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest < 10) { Main.LocalPlayer.GetModPlayer<Quests>().PhilosopherStoneQuest = 0; }
                }
            }
            else {
                if (Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest < 10) { Main.LocalPlayer.GetModPlayer<Quests>().SunriseQuest = 0; }
            ...
            if (QuestVariable.PotionQuest == 200) {
                NPC.netUpdate = true;
                ...
                CameraSystem.FocusOn(ModContent.NPCType<AlchemistDeath>());
                NPC.active = false;
            }
        }
    }
