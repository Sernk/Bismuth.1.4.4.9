...
namespace Bismuth.Content.NPCs {
    public class SwampWitchDeath : ModNPC {
        ...
        public override void SetStaticDefaults() => Main.npcFrameCount[NPC.type] = 30;
        public override void AI() {
            ...
            NPC.velocity.Y = 4f;
            if (currentframe > 0) { Lighting.AddLight(NPC.Center, new Vector3(0.25f, 0.67f, 0.99f)); }
        }
